...
public class Replacement_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_replacement_);
        replace = findViewById(R.id.replace);
        new REPLCAe().execute();
    }

    private class REPLCAe extends AsyncTask<String, Void, String> {
        ProgressDialog dialog;

        protected void onPreExecute() {
            dialog = new ProgressDialog(Replacement_Activity.this);
            dialog.show();
